...
- 🎨 **纯文本生图功能** — 新增 `clawmate_generate_image` 工具，支持无需参考图的纯文本生图，适用于生成动物、风景、物品等非角色图片
- 🔗 **图片转视频工作流** — 支持将生成的图片转换为短视频，完整的图片→视频生成链路
...
- **纯文本生图** — 无需参考图，直接根据文本描述生成图片（动物、风景、物品等）
- **多视角拍摄** — 支持三种拍摄模式：
  - `direct`：普通自拍视角
  - `mirror`：对镜全身照
...
- [x] **视频生成** — 短视频片段生成
- [x] **纯文本生图** — 无需参考图的图片生成功能
- [x] **灵活配置** — Provider 配置标准化，支持多服务商切换
- [ ] **更多角色** — 添加不同性格和背景的内置角色
- [ ] **语音交互** — 角色语音合成，支持语音对话
- [ ] **动态表情** — 更丰富的表情和动作库
- [ ] **社区角色** — 角色分享和下载平台
...
纯文本生图，通过第三方服务（如 grokimagine）创建图片。
